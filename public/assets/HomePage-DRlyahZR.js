import{r as T,j as g,a as o,c as h,C as J,d as pt,h as gt,i as bt,k as yt,R as Z,b as _,u as at,e as rt,f as ot,H as nt,F as vt,l as xt,L as wt}from"./index-BDacah9G.js";import{P as St}from"./PrimaryButton-BkYAsUlW.js";import{B as Et}from"./BlogSection-J6zbLmM5.js";import{C as N}from"./Card-X6RVUTRt.js";import{I as Vt}from"./Image-C1IGWyv_.js";import{P as Ot}from"./PageMeta-fADpcX7y.js";function Ct({about:r,bgImage:i}){const[s,u]=T.useReducer(e=>e+1,0);return T.useEffect(()=>{const e=()=>u();return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}},[]),T.useEffect(()=>{const e=document.getElementById("about-us-section-text"),f=document.getElementById("about-us-section-banner"),d=e.clientHeight;f.style.height=`${d+100}px`},[s]),g("div",{style:{position:"relative"},children:[o("div",{id:"about-us-section-banner",css:h`
