import{E as u,u as c,e as g,f as m,r as p,a,j as s,c as r,G as h,C as f,I as i,H as x,F as y,L as v,l as w}from"./index-BDacah9G.js";import{B as P}from"./BlogSection-J6zbLmM5.js";import{P as C}from"./PageMeta-fADpcX7y.js";import{I as L}from"./Image-C1IGWyv_.js";import"./PrimaryButton-BkYAsUlW.js";import"./Card-X6RVUTRt.js";function S(){const{slug:d}=u(),t=c(`${g}/api/post/${d}`,m),o=c(`${g}/api/post?page=1&limit=6`,m);return p.useEffect(()=>{(async()=>await t.mutate())()},[d]),t.isLoading||o.isLoading?a(v,{}):t.error||o.error?a(w,{}):s(y,{children:[a(C,{title:t.data.data.title,description:t.data.data.highlight,ogImage:t.data.data.cover}),a(h,{styles:r`
