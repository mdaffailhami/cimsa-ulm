import{E as u,u as c,e as g,f as m,r as p,a,j as s,c as r,G as h,C as f,I as i,H as x,F as y,L as v,l as w}from"./index-CdoKCSUK.js";import{B as P}from"./BlogSection-D0hBo0Ia.js";import{P as C}from"./PageMeta-D59WkTr3.js";import{I as L}from"./Image-Bv3cQMHz.js";import"./PrimaryButton-aJuwTzJ4.js";import"./Card-BrVf6z4T.js";function S(){const{slug:d}=u(),t=c(`${g}/api/post/${d}`,m),o=c(`${g}/api/post?page=1&limit=6`,m);return p.useEffect(()=>{(async()=>await t.mutate())()},[d]),t.isLoading||o.isLoading?a(v,{}):t.error||o.error?a(w,{}):s(y,{children:[a(C,{title:t.data.data.title,description:t.data.data.highlight,ogImage:t.data.data.cover}),a(h,{styles:r`
