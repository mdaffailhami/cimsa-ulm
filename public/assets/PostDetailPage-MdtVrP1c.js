import{E as u,u as c,e as g,f as m,r as p,a,j as s,c as r,G as h,C as f,I as i,H as x,F as y,L as v,l as w}from"./index-CYOINDUC.js";import{B as P}from"./BlogSection-CLYRVrzR.js";import{P as C}from"./PageMeta-BK7fhlHm.js";import{I as L}from"./Image-B4iatA0O.js";import"./PrimaryButton-DAn745lr.js";import"./Card-q-zL4AqX.js";function S(){const{slug:d}=u(),t=c(`${g}/api/post/${d}`,m),o=c(`${g}/api/post?page=1&limit=6`,m);return p.useEffect(()=>{(async()=>await t.mutate())()},[d]),t.isLoading||o.isLoading?a(v,{}):t.error||o.error?a(w,{}):s(y,{children:[a(C,{title:t.data.data.title,description:t.data.data.highlight,ogImage:t.data.data.cover}),a(h,{styles:r`
