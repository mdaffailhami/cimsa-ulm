...
class PageSeeder extends Seeder
{
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'text',
                        'section' => 'banner',
                        'value' => "CENTER FOR INDONESIAN MEDICAL STUDENTS' ACTIVITIES",
                    ],
                    [
                        "label" => 'Banner Image',
                        "type" => 'image',
            ...
            [
                ...
                'contents' => [
                    ...
                    [
                        ...
                        "type" => 'long-text',
                        'section' => 'sdgs',
                        'value' => 'We believe in the <b>Sustainable Development Goals (SDGs)</b> and are especially aiding the completion of SDG 3 (Good Health), 4 (Quality Education), 5 (Gender Equality), and 13 (Climate Action).',
                        'image_content' => null
                    ],
                    [
                        "label" => 'SDGs',
                    ...
                    [
                        ...
                        "type" => 'text',
                        'section' => 'vision-mission',
                        'value' => 'We have formulized our vision and mission in the hopes that CIMSA UGM can better address the problems in our area.',
                        'image_content' => null
                    ],
                    [
                        "label" => 'Vision',
                        "type" => 'long-text',
                        'section' => 'vision-mission',
                        'value' => 'CIMSA ULM sebagai organisasi mahasiswa kedokteran yang adaptif, dinamis, dan bergairah dalam melaksanakan program kerja berkelanjutan serta mewujudkan lingkungan yang profesional dan harmonis bagi para member dan officials.',
                        'image_content' => null
                    ],
                    [
                        "label" => 'Missions',
                        ...
                        'value' => json_encode([
                            [
                                "label" => "INTERNAL",
                                "type" => "long-text",
                                "value" => "Mewujudkan <b>CIMSA ULM</b> yang mampu menginspirasi melalui pemberdayaan individu dalam aktivitas relevan dan progresif berdasarkan riset dan data untuk memberikan pengaruh kepada member dan masyarakat."
                            ],
                            [
                                "label" => "EXTERNAL",
                                "type" => "long-text",
                                "value" => "Mengoptimalkan hubungan dan kerja sama dengan pihak eksternal dan alumni senior, meningkatkan penggunaan media yang eksploratif, serta melaksanakan advokasi yang berkelanjutan sebagai perwujudan mahasiswa kedokteran yang aktif dan tanggap isu."
                            ],
                            [
                                "label" => "ADMINISTRATION",
                                "type" => "long-text",
                                "value" => "Kesekretariatan <b><i>CIMSA ULM</i></b> yang efektif, profesional, terintegrasi, dan berbasis teknologi dengan adanya sistem administrasi yang terstandarisasi SOP dan akomodatif bagi member dan officials."
                            ],
                            [
                                "label" => "FINANCE",
                                "type" => "long-text",
                                "value" => "Mengelola dan menjaga kestabilan keuangan CIMSA UGM melalui optimalisasi perencanaan keuangan dan fundraising yang terstruktur, strategis, dan inovatif untuk mendukung program kerja organisasi."
                            ],
                            [
                                "label" => "ORGANIZATIONAL DEVELOPMENT",
                                "type" => "long-text",
                                "value" => "Mengoptimalkan pemanfaatan riset dan data dengan berpedoman pada AD/ART serta rencana strategis untuk mendukung pengembangan organisasi."
                            ]
                        ]),
                        'image_content' => null
                    ],
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => 'description',
                        'value' => "We organize our work through six Standing Committees that represent focus areas of equal importance in order to maintain a balanced, holistic, and steady approach towards our targets and goals.",
                        'image_content' => null
                    ],
                ],
                'contact' => null
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => "Ever-expanding efforts, CIMSA UGM is always looking for opportunities to collaborate and make greater impacts.",
                        'image_content' => null
                    ],
                    [
                        "label" => 'Web3Forms Key',
                        "type" => 'text',
                        'section' => null,
                        'value' => "c95eefba-3246-43b9-8f02-87afe5cb48c9",
                        'image_content' => null
                    ],
                    [
                        "label" => 'Map URL',
                        "type" => 'text',
                        'section' => null,
                        'value' => 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.211029688729!2d114.58294921060936!3d-3.2978638966631637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de4230963790c57%3A0x902859712cc02755!2sLambung%20Mangkurat%20University%20-%20Campus%20I%20Banjarmasin!5e0!3m2!1sen!2sid!4v1734245455540!5m2!1sen!2sid',
                        'image_content' => null
                    ],
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => "CIMSA ULM is forever thankful to those who have contributed their hearts, spirits, and time to making CIMSA ULM what it is today. This is a page dedicated to our alumni and seniors.",
                    ],
                    [
                        "label" => 'Map Image',
                        "type" => 'image',
            ...
            [
                ...
                'contents' => [
                    ...
                    [
                        ...
                        "type" => 'long-text',
                        'section' => 'programs',
                        'value' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolores quasi nihil, voluptatibus doloribus illum porro sint debitis nam aliquid nobis nemo consequatur, sit vel necessitatibus excepturi, id praesentium quae.
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => 'We manifest the will to achieve our goals through ways that are relevant-to-the-issue, sustainable, and accountable.',
                    ],
                    [
                        "label" => 'Activities Description',
                        "type" => 'long-text',
                        'section' => 'programs',
                        'value' => 'Our <b>bread</b> and butter. CIMSA delivers its impacts through executing activities tailored to our goals and visions.',
                    ],
                    [
                        "label" => 'Activities Images',
                        "type" => 'multiple-image',
                        'section' => 'programs',
                        'value' => null,
                    ],
                    [
                        ...
                        "type" => 'long-text',
                        'section' => 'programs',
                        'value' => 'We <b>understand</b> that reaching our goals would require a multifaceted effort. We identify our stakeholders and we advocate.',
                    ],
                    [
                        "label" => 'Advocacy Images',
                        "type" => 'multiple-image',
                        'section' => 'programs',
                        'value' => null,
                    ],
                    [
                        ...
                        "type" => 'long-text',
                        'section' => 'programs',
                        'value' => 'We <b>act</b> on based on what’s happening and evaluate by data.Research shapes our decisions and makes sure that what we do are held accountable.',
                    ],
                    [
                    ...
                    [
                        "label" => 'Capacity Building Description',
                        "type" => 'long-text',
                        'section' => 'programs',
                        'value' => 'With an <u><i><b>established</b></i></u> system of trainings supported by an ecosystem of active trainers, we continuously empower our members and facilitate the development of their potentials.',
                    ],
                    [
                        "label" => 'Capacity Building Images',
                        "type" => 'multiple-image',
                        'section' => 'programs',
                        'value' => null,
                    ],
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => 'True to our vision, CIMSA UGM aims to empower medical students in every possible aspect.',
                    ],
                    [
                        "label" => 'Trainers Description',
                        "type" => 'text',
                        'section' => null,
                        'value' => 'CIMSA has an established capacity building system where members may become trainers that will act as peer educators on various topics. These ‘trainings of trainers’ are conducted each year (some are held biennially), ensuring a steady production of trainers and a continuous stream of capacity buildings.',
                    ],
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => 'Meet the officials of CIMSA ULM. We are a team of dedicated and passionate individuals who work together to achieve our goals and make a positive impact in our community.',
                    ],
            ...
            [
                ...
                'contents' => [
                    [
                        ...
                        "type" => 'long-text',
                        'section' => null,
                        'value' => 'Content from our members, seniors, alumni, and activity reports.',
                    ],
    ...
    public function createPageContent($page_model, $data)
    {
        ...
        // For Text Content
        if ($data['type'] === 'text') {
            $payload['text_content'] = $data['value'];
        } elseif ($data['type'] === 'long-text') {
            $payload['long_text_content'] = $data['value'];
        } elseif ($data['type'] === 'multiple-value') {
            $payload['multiple_value_content'] = $data['value'];
        }
